...
public class RestAppli extends javax.ws.rs.core.Application
{
  ...
  private void addRestResourceClasses(Set<Class<?>> resources)
  {
    ...
    resources.add(service.ChangesetFacadeREST.class);
    resources.add(service.ContributeurFacadeREST.class);
    resources.add(service.DiffFacadeREST.class);
  }
}
/*
  private HashSet singls = new HashSet();
  public RestAppli()
  {
//Thread.dumpStack();
System.out.println("RESTAPPLI.");    
    singls.add(new DiffFacadeREST());
  }
...
//System.out.println("RESTAPPLI classes.");    
//    return resources;
//  }
//
//  @Override
...
//  {
////Thread.dumpStack();
////System.out.println("RESTAPPLI singletons. "+super.getSingletons());    
